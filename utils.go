...
func (PGDB *gorm.DB)GetFileRes() CheckRes {
	tres := CheckRes{
		Value: true,
	}
	fres := CheckRes{
...
func (GB *grom.DB)VerifyData(data FileResult) (dataRes string) {
...
func (PGDB *grom.DB)VerifyClusterCode(data string) (OK string) {
	var res RC
...
func (PGDB *grom.DB)RecordID(IDA string) (err error) {
...
func (PGDB *grom.DB)RegularUpdateC() {
	currentTime := GetCurrentTime()
...
func (PGDB *grom.DB)RegularCheckC() {
...
func (PGDB *grom.DB)CheckResInDB() (res string) {
...
func (PGDB *grom.DB)MakeResDB(res ResIDInfo, IdA string) {
...
func SendHeartBeat() {
	...
	if err1 != nil {
		println("error occur when send HB")
		return
	}
