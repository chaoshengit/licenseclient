...
func (GB *gorm.DB)RegisterCall(client RegisterBody) (error,CommonResponse) {
...
func (GB *gorm.DB)VerifyCall() CommonResponse {
	res := GB.GetFileRes()
...
func (GB *gorm.DB)GenClientIDCall(sn SNbody) (error,CommonResponse) {
